...
{
    public partial class ResultDNUserControl : UserControl
    {
        public ResultDNUserControl()
        {
            InitializeComponent();
        }
        ...
        protected void FillControl()
        {
            voidFunc vd = delegate
            {
                try
                {
                    ...
                    {
                        this.textBoxКоординаты_фазового_центра_1.Text = ResultTypesClassLibrary.ResultType_MAINClass.CordinatePhaseCentre(this._CalculationResult.Координаты_фазового_центра_Decart, false, this._Result.MainOptions.MeasurementResultType);
                    }
                    else
                    {
